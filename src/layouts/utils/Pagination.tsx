export const Pagination: React.FC<{
  ...
  //SAME LOGIC
  // const lowerBound = props.currentPage - 2;
  // const upperBound = props.currentPage + 2;
  // for(let pageNo=lowerBound;pageNo<=upperBound;pageNo++) {
  //     if(pageNo===1 || pageNo===props.totalPages)
  //         continue;
